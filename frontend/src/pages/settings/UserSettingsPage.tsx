          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 py-4 px-1 border-b-3 font-semibold text-sm transition-colors ${
                  activeTab === tab.id
          ...
          <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  return (
                    ...
                    >
                      <ThemeIcon className={`w-10 h-10 mb-3 ${
                        preferences.theme === theme.value
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Sitenin ana rengini özelleştirin
              </p>
              ...
              <div className="grid grid-cols-4 md:grid-cols-8 gap-3 mb-6">
                {predefinedColors.map((color) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-14 h-14 rounded-xl transition-all shadow-md flex items-center justify-center ${
                          isSelected
                      ...
                      >
                        {isSelected && (
                          <Check
                            className={`w-7 h-7 ${isLight ? 'text-gray-900' : 'text-white'}`}
                            strokeWidth={3}
                          />
                        )}
                      </div>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  description: 'Yaklaşan çalışma seansları için hatırlatma al',
                },
              ].map((item) => (
                <div
                  key={item.key}
        ...
        {activeTab === 'study' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Varsayılan Pomodoro Süresi (dk)
                </label>
                <input
                  type="number"
                  value={studyPrefs.defaultPomodoroDuration}
                  onChange={(e) =>
                    setStudyPrefs({ ...studyPrefs, defaultPomodoroDuration: parseInt(e.target.value) || 25 })
                  }
                  min="1"
                  max="90"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setStudyPrefs({ ...studyPrefs, defaultShortBreak: parseInt(e.target.value) || 5 })
                  }
                  min="1"
                  max="30"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setStudyPrefs({ ...studyPrefs, defaultLongBreak: parseInt(e.target.value) || 15 })
                  }
                  min="1"
                  max="60"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Uzun Molaya Kadar Pomodoro Sayısı
                </label>
                <input
                  type="number"
                  value={studyPrefs.pomodorosUntilLongBreak}
                  onChange={(e) =>
                    setStudyPrefs({ ...studyPrefs, pomodorosUntilLongBreak: parseInt(e.target.value) || 4 })
                  }
                  min="2"
                  max="10"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setStudyPrefs({ ...studyPrefs, weeklyStudyGoal: parseInt(e.target.value) || 20 })
                  }
                  min="1"
                  max="100"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
